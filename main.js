...
(() => {
  ...
  const HE = {
    ...
    "a7": "לא מתוכנה לבד, ומי שמבטיח את זה מוכר לכם משהו. מה שבאמת מזיז את המספר: פריסט Potato, שום דבר שנלחם עם המשחק על המעבד (בוסט הפעלה), טאב ב-1080p במקום 4K בזמן משחק, מסך בקצב הרענון האמיתי שלו, ובמחשב עם מקל זיכרון אחד של 16 GB — מקל שני. כל טוויק באפליקציה אומר מה הוא משנה ואפשר לבדוק A/B עם Shift+F5.",
