...
(() => {
  ...
  const HE = {
    ...
    "f4.t": "טוויקים למחשב, בכנות",
    "f4.p": "השהיית קלט, רשת, רזולוציית טיימר, תוכנית החשמל של FishLaunch. כל טוויק אומר מה הוא משנה ומראה אם זה נתפס.",
    "f5.t": "כוונת + Fortnite",
    "f5.p": "כוונת מותאמת אישית מעל המשחק, הגדרות הפעלה ומודים ל-Fortnite — אותה אפליקציה לשני המשחקים.",
    "f6.t": "מתעדכן לבד",
    "f6.p": "מתקינים פעם אחת. גרסאות חדשות חתומות ומגיעות לבד — החברים שלך תמיד על אותו build כמוך.",
    "b.eyebrow": "אפליקציה נלווית",
    "b.p": "דפדפן מהיר וכהה לגיימרים: פרסומות ומעקב נחסמים לפני שהם נטענים, כפתור ה-Play של Roblox נפתח ישר ב-FishLaunch, מסך מלא אמיתי לסרטונים, ואותו מראה כמו הלאנצ'ר.",
