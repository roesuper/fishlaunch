...
(() => {
  ...
  const HE = {
    ...
    "f5.t": "Smart Tune · 1,145 טוויקים",
    "f5.p": "סורק את המחשב, שואל במה אתה משחק ומה חשוב לך, ובונה תוכנית: מה טוב בשבילך, מה דורש זהירות ומה לדלג — עם תוכנית חשמל מותאמת וביטול בקליק של כל ערך. אף פעם לא נוגע באבטחה של Windows.",
    "f6.t": "מתעדכן לבד",
    "f6.p": "מתקינים פעם אחת. גרסאות חדשות חתומות ומגיעות לבד — החברים שלך תמיד על אותו build כמוך.",
    "new": "חדש",
    "f7.t": "רופא ה-FPS",
    "f7.p": "סורק את המחשב ומוצא מה באמת מגביל את ה-FPS — זיכרון בערוץ אחד, XMP כבוי, כרטיס מסך בחריץ איטי, הגבלות FPS נסתרות בדרייבר או ב-RivaTuner — מתקן מה שתוכנה יכולה ונותן הוראות צעד-אחר-צעד לשאר.",
    "f8.t": "טיימר ירח מלא לבלוקס פרוטס",
    "f8.p": "יודע מתי הירח המלא עולה בשרת הפרטי שלך, מזהיר 5 דקות לפני, מראה ספירה לאחור בתוך המשחק ופותח שרת חדש לירח הבא. ועוד טיימרים לחידושי מלאי של מוכרי הפירות.",
    "f9.t": "פונטים לרובלוקס",
    "f9.p": "מחליפים כל פונט ברובלוקס — תפריטים, צ'אט, שמות — ל-Luckiest Guy, Press Start 2P, Bangers או כל פונט במחשב. עברית ואימוג'ים ממשיכים לעבוד.",
    "f10.t": "קודי סטאפ",
    "f10.p": "כל הסטאפ שלך — פריסט, הגבלת FPS, סמן, פונט, כוונת, צבעים — בקוד FISH- אחד. מפרסמים, ומי שמדביק מקבל בדיוק את הסטאפ שלך.",
    "f11.t": "דו-קרב תוכניות חשמל",
    "f11.p": "מחליף בין תוכניות החשמל שלך בזמן שאתה משחק, מודד את ה-FPS האמיתי בכל אחת ומשאיר את המהירה. בלי לנחש איזו תוכנית \"הכי טובה\".",
    "f12.t": "רמות והישגים",
    "f12.p": "XP על כל שעת משחק, רצפים ו-21 תגים — מרתון, ינשוף לילה, צייד ירחים, דו-קרבן. ועוד כוונת שעובדת עכשיו גם ברובלוקס.",
    ...
    "q6": "האם \"בוסט הפעלה\" נוגע במשחק?",
    "a6": "לא. העדיפות היא דגל הפעלה ומסכת ליבות ה-P עוברת בירושה מ-FishLaunch ברגע שרובלוקס נוצר — תהליך המשחק לעולם לא נפתח, נקרא או נכתב, אז אין ל-Byfron או EAC מה לראות. מצב פוקוס נוגע רק באפליקציות אחרות (דפדפנים, לאנצ'רים, סנכרון) ומחזיר אותן כשיוצאים.",
    "q7": "זה ייתן לי 300 FPS?",
    "a7": "לא מתוכנה לבד, ומי שמבטיח את זה מוכר לכם משהו. מה שבאמת מזיז את המספר: פריסט Potato, שום דבר שנלחם עם המשחק על המעבד (בוסט הפעלה), טאב ב-1080p במקום 4K בזמן משחק, מסך בקצב הרענון האמיתי שלו, ובמחשב עם מקל זיכרון אחד של 16 GB — מקל שני. רופא ה-FPS באפליקציה בודק את כל אלה במחשב שלך תוך חמש שניות, ו-Smart Tune מודד את ה-FPS לפני ואחרי כדי שתראה מה באמת השתנה.",
